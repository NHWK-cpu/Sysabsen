...
export function TeacherDashboard() {
  ...
  const [selectedDate, setSelectedDate] = useState<Date>(new Date(2026, 2, 25)); // March 25, 2026
      ...
      <div className="bg-card border-b px-4 md:px-6 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <Popover>
              <PopoverTrigger className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground p-0 h-auto font-normal bg-transparent border-0 cursor-pointer">
