...
func main() {
	...
	http.HandleFunc("/register/siswa", controllers.RegisterSiswaPublic)
	...
	http.HandleFunc("/admin/siswa/pending-registrations", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.GetPendingSiswaRegistrations)))
	http.HandleFunc("/admin/siswa/approve-registration", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.ApproveSiswaRegistration)))
	http.HandleFunc("/admin/siswa/reject-registration", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.RejectSiswaRegistration)))
    ...
    http.HandleFunc("/admin/kelas/set-wali", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.SetWaliKelas)))
    http.HandleFunc("/admin/kelas/remove-wali", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.RemoveWaliKelas)))
	...
	http.HandleFunc("/admin/siswa-kelas/assign", middlewares.JWTMiddleware(middlewares.AdminOrGuru(controllers.AssignSiswaToKelas)))
	http.HandleFunc("/admin/siswa-kelas/update", middlewares.JWTMiddleware(middlewares.AdminOrGuru(controllers.UpdateSiswaKelas)))
    http.HandleFunc("/admin/siswa-kelas/remove", middlewares.JWTMiddleware(middlewares.AdminOrGuru(controllers.RemoveSiswaFromKelas)))
    http.HandleFunc("/admin/siswa-kelas/reset-absen", middlewares.JWTMiddleware(middlewares.AdminOrGuru(controllers.ResetAbsensiSiswa)))
    ...
    http.HandleFunc("/admin/siswa/import", middlewares.JWTMiddleware(middlewares.AdminOnly(controllers.ImportExcelSiswa)))
    ...
    http.HandleFunc("/superadmin/logs", middlewares.JWTMiddleware(middlewares.SuperAdminOnly(controllers.GetActivityLogs)))
    ...
    http.HandleFunc("/guru/siswa/all", middlewares.JWTMiddleware(middlewares.GuruOnly(controllers.GetAllSiswaForGuru)))
    ...
    http.HandleFunc("/guru/kelas/siswa", middlewares.JWTMiddleware(middlewares.GuruOnly(controllers.GetSiswaByKelasUntukGuru)))
